...
from recharge_si.pages.navigation import NavigationPage
from recharge_si.pages.product import ProductPage


class RechargeSiSpider(scrapy.Spider):
    name = "recharge_si"
    allowed_domains = ["www.recharge.si"]
    start_urls = ["https://www.recharge.si/"]
